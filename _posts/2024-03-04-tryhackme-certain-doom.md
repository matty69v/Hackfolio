...
image:
  path: /images/tryhackme_certain-doom/room_image.webp
---
...
[![Tryhackme Room Link](/images/tryhackme_certain_doom/room_card.webp)](https://tryhackme.com/r/room/certaindoom){: .center }
...
![Web 80 Index](/images/tryhackme_certain_doom/web_80_index.webp)
...
![Web 8080 Index](/images/tryhackme_certain_doom/web_8080_index.webp)
...
![Web 8080 Reports](/images/tryhackme_certain_doom/web_8080_reports.webp)
...
![Web 8080 Reports Upload](/images/tryhackme_certain_doom/web_8080_reports_upload.webp)
...
![Web 8080 Reports Upload Payload](/images/tryhackme_certain_doom/web_8080_reports_upload_payload.webp)
...
![Burp Proxy Setting](/images/tryhackme_certain_doom/burp_proxy_setting.webp)

After this, visiting `http://172.20.0.2/`, we see the `Documents Library` application.

![Library Front-End Index](/images/tryhackme_certain_doom/library_frontend_index.webp)
...
![Library Back-End Request](/images/tryhackme_certain_doom/library_backend_request.webp)
...
![Library Back-End Request CORS](/images/tryhackme_certain_doom/library_backend_request_cors.webp)

Trying a couple of different origins, we are successful with `library`.

![Library Back-End Request Origin](/images/tryhackme_certain_doom/library_backend_request_origin.webp)
...
![Library Front-End Login](/images/tryhackme_certain_doom/library_frontend_login.webp)

Testing the form, we see it makes a login request to `http://library-back:8080/j_security_check`.

![Library Back-End Login Request](/images/tryhackme_certain_doom/library_backend_login_request.webp)

After trying a few basic credentials, we successfully login with `bob:bob`, and the server returns the `credz` cookie.

![Library Back-End Login](/images/tryhackme_certain_doom/library_backend_login.webp)

Now that we are logged in, we examine `http://library/build/p-dc627381.entry.js` to understand how the application works.

![Library Front-End JS](/images/tryhackme_certain_doom/library_frontend_js.webp)
...
![Library Back-End Files](/images/tryhackme_certain_doom/library_backend_files.webp)

However, using the `hidden=true` argument to search for hidden files, we discover two more.

![Library Back-End Hidden Files](/images/tryhackme_certain_doom/library_backend_hidden_files.webp)

Downloading the `chat.log` file, we obtain the second flag.

![Library Back-End Second Flag](/images/tryhackme_certain_doom/library_backend_second_flag.webp)
...
![Library Back-End Hydras Files](/images/tryhackme_certain_doom/library_backend_hydras_files.webp)

Trying to find any hidden files belonging to the `hydra` user, we only get the hidden files belonging to the current user.

![Library Back-End Hydras Hidden Files](/images/tryhackme_certain_doom/library_backend_hydras_hidden_files.webp)
...
![Library Back-End Invalid Token](/images/tryhackme_certain_doom/library_backend_invalid_token.webp)
...
![Library Back-End Valid Token](/images/tryhackme_certain_doom/library_backend_valid_token.webp)

With a valid token, listing the hidden files belonging to the user reveals `specs.pdf`.

![Library Back-End Hydras Hidden Files Two](/images/tryhackme_certain_doom/library_backend_hydras_hidden_files2.webp)
