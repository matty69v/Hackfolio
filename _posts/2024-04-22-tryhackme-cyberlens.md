...
![Web 80 Index](/images/tryhackme_cyberlens/web_80_index.webp)

### WEB 61777

Visiting `http://cyberlens.thm:61777/`, we see that `Apache Tika 1.17 Server` is running.

![Web 61777 Index](/images/tryhackme_cyberlens/web_61777_index.webp)
...
![Web 80 Parsed](/images/tryhackme_cyberlens/web_80_parsed.webp)
...
![Web 80 Image Upload](/images/tryhackme_cyberlens/web_80_image_upload.webp)
...
![RDP User Flag](/images/tryhackme_cyberlens/rdp_user_flag.webp)
...
![RDP Add User](/images/tryhackme_cyberlens/rdp_adduser.webp)
...
![RDP Run As Administrator](/images/tryhackme_cyberlens/rdp_run_as_administrator.webp)

![RDP UAC](/images/tryhackme_cyberlens/rdp_uac.webp)

At last, we can finish the room by reading the admin flag using this new Powershell process.

![RDP Root Flag](/images/tryhackme_cyberlens/rdp_root_flag.webp)
