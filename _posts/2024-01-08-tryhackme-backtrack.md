...
[![Tryhackme Room Link](/images/tryhackme_backtrack/room_card.webp)](https://tryhackme.com/r/room/backtrack){: .center }
...
![Web 8080 Index](/images/tryhackme_backtrack/web_8080_index.webp)

### Web 8888

Checking `http://10.10.61.142:8888/`, we find an `Aria2 WebUI` installation.

![Web 8888 Index](/images/tryhackme_backtrack/web_8888_index.webp)

In the `Settings -> Server info`, we can see the version is `1.35.0`.

![Web 8888 Server Info](/images/tryhackme_backtrack/web_8888_server_info.webp)
...
![Web 80 Index](/images/tryhackme_backtrack/web_80_index.webp)
...
![Web 80 Dashboard](/images/tryhackme_backtrack/web_80_dashboard.webp)

Unsurprisingly, we can upload images and view them in the `/uploads` directory.

![Web 80 File Upload One](/images/tryhackme_backtrack/web_80_file_upload_one.webp)
...
![Web 80 File Upload Two](/images/tryhackme_backtrack/web_80_file_upload_two.webp)
...
![Web 80 File Upload Three](/images/tryhackme_backtrack/web_80_file_upload_three.webp)

However, visiting `/uploads/rev.png.php` shows that our **PHP** code does not execute.

![Web 80 File Upload Four](/images/tryhackme_backtrack/web_80_file_upload_four.webp)
...
![Web 80 File Upload Five](/images/tryhackme_backtrack/web_80_file_upload_five.webp)

Now, we can access our web shell at `/rev.png.php` and run commands.

![Web 80 File Upload Six](/images/tryhackme_backtrack/web_80_file_upload_six.webp)
