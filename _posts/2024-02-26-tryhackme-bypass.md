...
![Web Server Port 80 Forbidden](/images/tryhackme_bypass/web_80_ip_forbidden.webp)

### Port 443

Visiting port 443 by IP, we also get the same forbidden page as before.

![Web Server Port 443 Forbidden](/images/tryhackme_bypass/web_443_ip_forbidden.webp)

Using the `cctv.thm` hostname, we get a login page.

![Web Server Port 443 Login Page](/images/tryhackme_bypass/web_443_host_login_page.webp)

Checking the source code for the login page, we discover the `/mail` endpoint in one of the comments.

![Web Server Port 443 Login Page Sourcecode](/images/tryhackme_bypass/web_443_login_page_sourcecode.webp)

At `https://cctv.thm/mail/`, indexing is enabled and we discover the `dump.txt` file.

![Web Server Port 443 Mail Endpoint](/images/tryhackme_bypass/web_443_mail_endpoint.webp)
...
![Web Server Port 443 First Flag](/images/tryhackme_bypass/web_443_first_flag.webp)
...
![Web Server Port 443 Second Flag](/images/tryhackme_bypass/web_443_second_flag.webp)
...
![Web Server Port 443 Third Flag](/images/tryhackme_bypass/web_443_third_flag.webp)
...
![Web Server Port 443 Fourth Flag](/images/tryhackme_bypass/web_443_fourth_flag.webp)
...
![Web Server Port 443 Fifth Flag](/images/tryhackme_bypass/web_443_fifth_flag.webp)
...
![Web Server Port 443 Second Login Page](/images/tryhackme_bypass/web_443_second_login_page.webp)
