...
image:
  path: /images/tryhackme_mouse-trap/room_image.webp
---
...
[![Tryhackme Room Link](/images/tryhackme_mouse_trap/room_card.webp)](https://tryhackme.com/r/room/mousetrap){: .center }
...
![Web 9099 Index](/images/tryhackme_mouse_trap/web_9099_index.webp)
...
![Event Viewer Sysmon](/images/tryhackme_mouse_trap/event_viewer_sysmon.webp)

![Event Viewer Sysmon Two](/images/tryhackme_mouse_trap/event_viewer_sysmon2.webp)

Now, let's open the `SysmonView.exe` on the desktop and use `File -> Import Sysmon Event Logs` to import our logs.

![Sysmon View](/images/tryhackme_mouse_trap/sysmon_view.webp)

![Sysmon View Two](/images/tryhackme_mouse_trap/sysmon_view2.webp)
...
![Sysmon View Hierarchy](/images/tryhackme_mouse_trap/sysmon_view_hierarchy.webp)
...
![Sysmon View Answers](/images/tryhackme_mouse_trap/sysmon_view_answers.webp)
...
![Sysmon View Answers Two](/images/tryhackme_mouse_trap/sysmon_view_answers2.webp)
...
![Sysmon View Answers Three](/images/tryhackme_mouse_trap/sysmon_view_answers3.webp)
...
![Sysmon View Answers Four](/images/tryhackme_mouse_trap/sysmon_view_answers4.webp)
...
![Sysmon View Answers Five](/images/tryhackme_mouse_trap/sysmon_view_answers5.webp)
...
![Sysmon View Answers Six](/images/tryhackme_mouse_trap/sysmon_view_answers6.webp)
...
![Sysmon View Answers Seven](/images/tryhackme_mouse_trap/sysmon_view_answers7.webp)
