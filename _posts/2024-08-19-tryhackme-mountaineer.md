...
[![Tryhackme Room Link](/images/tryhackme_mountaineer/room_card.webp)](https://tryhackme.com/r/room/mountaineerlinux){: .center }
...
![Web 80 Index](/images/tryhackme_mountaineer/web_80_index.webp)
...
![Web 80 Wordpress](/images/tryhackme_mountaineer/web_80_wordpress.webp)
...
![Web 80 Wordpress Two](/images/tryhackme_mountaineer/web_80_wordpress2.webp)
...
![Web 80 Nginx OBS](/images/tryhackme_mountaineer/web_80_nginx_obs.webp)

Using this to read the `/etc/nginx/sites-available/default` file, we discover a vhost: `adminroundcubemail.mountaineer.thm`.

![Web 80 Nginx OBS Two](/images/tryhackme_mountaineer/web_80_nginx_obs2.webp)

Additionally, inside the same file, we can see the cause of the vulnerability.

![Web 80 Nginx OBS Three](/images/tryhackme_mountaineer/web_80_nginx_obs3.webp)
...
![Web 80 Roundcube](/images/tryhackme_mountaineer/web_80_roundcube.webp)
...
![Web 80 Roundcube Two](/images/tryhackme_mountaineer/web_80_roundcube2.webp)

Next, checking the `Getting to know you!` email in the sent section, we learn quite a bit about the `lhotse` user.

![Web 80 Roundcube Three](/images/tryhackme_mountaineer/web_80_roundcube3.webp)
...
![Web 80 Wordpress Login](/images/tryhackme_mountaineer/web_80_wordpress_login.webp)
...
![Web 80 Wordpress Shell](/images/tryhackme_mountaineer/web_80_wordpress_shell.webp)
...
![Web 80 Wordpress Shell Two](/images/tryhackme_mountaineer/web_80_wordpress_shell2.webp)
...
![Web 80 Wordpress Lost Password](/images/tryhackme_mountaineer/web_80_wordpress_lost_password.webp)
...
![Web 80 Wordpress Lost Password Two](/images/tryhackme_mountaineer/web_80_wordpress_lost_password2.webp)
...
![Web 80 Wordpress Lost Password Three](/images/tryhackme_mountaineer/web_80_wordpress_lost_password3.webp)
...
![Web 80 Wordpress Lost Password Four](/images/tryhackme_mountaineer/web_80_wordpress_lost_password4.webp)
...
![Web 80 Wordpress Lost Password Five](/images/tryhackme_mountaineer/web_80_wordpress_lost_password5.webp)
