...
image:
  path: /images/tryhackme_burg3rbytes/room_image.webp
---
...
![Web Server Port 80 Index](/images/tryhackme_burg3rbytes/web_80_index.webp)
...
![Web Server Port 80 Checkout](/images/tryhackme_burg3rbytes/web_80_checkout.webp)

Guessing what might be a valid voucher, we get a `50%` discount with the `TRYHACK3M` voucher.

![Web Server Port 80 Checkout](/images/tryhackme_burg3rbytes/web_80_checkout_discount.webp)
...
![Web Server Port 80 Checkout Race Condition](/images/tryhackme_burg3rbytes/web_80_checkout_race_condition.webp)
...
![Web Server Port 80 Checkout Receipt](/images/tryhackme_burg3rbytes/web_80_checkout_receipt.webp)

### SSTI

At `http://10.10.141.221/receipt/82739098304716027352341076?name=jxf`, we see a receipt for our purchase.

![Web Server Port 80 Receipt](/images/tryhackme_burg3rbytes/web_80_receipt.webp)
...
![Web Server Port 80 Receipt SSTI](/images/tryhackme_burg3rbytes/web_80_receipt_ssti.webp)
...
![Web Server Port 80 Receipt SSTI RCE](/images/tryhackme_burg3rbytes/web_80_receipt_ssti_rce.webp)
...
![Web Server Port 80 Receipt SSTI Reverse Shell](/images/tryhackme_burg3rbytes/web_80_receipt_ssti_revshell.webp)
