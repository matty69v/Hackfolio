...
[![Tryhackme Room Link](/images/tryhackme_smol/room_card.webp)](https://tryhackme.com/r/room/smol){: .center }
...
![Web 80 Index](/images/tryhackme_smol/web_80_index.webp)
...
![Web 80 File Disclosure Wpconfig](/images/tryhackme_smol/web_80_file_disclosure_wpconfig.webp)

We can test these credentials for the **WordPress** login at `http://www.smol.thm/wp-login.php`.

![Web 80 Wordpress Login](/images/tryhackme_smol/web_80_wordpress_login.webp)

As the credentials work, we successfully log in and gain access to the **WordPress** dashboard.

![Web 80 Wordpress Dashboard](/images/tryhackme_smol/web_80_wordpress_dashboard.webp)

After accessing the dashboard, we check the pages and find a private page titled `Webmaster Tasks!!`.

![Web 80 Wordpress Pages](/images/tryhackme_smol/web_80_wordpress_pages.webp)
...
![Web 80 Wordpress Todo](/images/tryhackme_smol/web_80_wordpress_todo.webp)
...
![Web 80 File Disclosure Hellodolly](/images/tryhackme_smol/web_80_file_disclosure_hellodolly.webp)
...
![Web 80 Wordpress Hellodolly](/images/tryhackme_smol/web_80_wordpress_hellodolly.webp)
...
![Web 80 Wordpress Shell](/images/tryhackme_smol/web_80_wordpress_shell.webp)
