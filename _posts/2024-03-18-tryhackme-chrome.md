...
image:
  path: /images/tryhackme_chrome/room_image.webp
---
...
![Wireshark Opening Statistics](/images/tryhackme_chrome/wireshark_opening_statistics.webp)

We notice most of the traffic inside is from the SMB protocol.

![Wireshark Statistics](/images/tryhackme_chrome/wireshark_statistics.webp)

## Extracting the files

Checking for files transferred with the SMB protocol.

![Wireshark SMB Export](/images/tryhackme_chrome/wireshark_smb_export.webp)

There are two interesting files:

![Wireshark SMB Files](/images/tryhackme_chrome/wireshark_smb_files.webp)
...
![Transfer.exe In Dnspy](/images/tryhackme_chrome/transfer_exe_dnspy.webp)
...
![Dnspy Edit Method](/images/tryhackme_chrome/dnspy_edit_method.webp)

Making the changes to perform decryption.

![Transfer.exe Edited](/images/tryhackme_chrome/transfer_exe_edited.webp)
...
![Encrypted_files Decryption](/images/tryhackme_chrome/encrypted_files_decryption.webp)
