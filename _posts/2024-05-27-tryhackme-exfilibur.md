...
![BlogEngine.NET Version](/images/tryhackme_exfilibur/web_blog_version.webp)
...
![BlogEngine.NET Directory Disclosure](/images/tryhackme_exfilibur/web_blog_directory_disclosure.webp)

Looking for interesting files, we discover `users.xml` inside `/App_Data/`.

![BlogEngine.NET Users File](/images/tryhackme_exfilibur/web_blog_users_file.webp)
...
![BlogEngine.NET Remote XML Fail](/images/tryhackme_exfilibur/web_blog_remote_xml_fail.webp)
...
![BlogEngine.NET Remote XML Success](/images/tryhackme_exfilibur/web_blog_remote_xml_success.webp)
...
![BlogEngine.NET Draft Page](/images/tryhackme_exfilibur/web_blog_draft_page.webp)

Checking the draft page, we get a password for King Arthur.

![BlogEngine.NET King Arthur Pass](/images/tryhackme_exfilibur/web_blog_king_arthur_pass.webp)
...
![BlogEngine.NET Page Editor File Upload](/images/tryhackme_exfilibur/web_blog_page_edit_file_upload.webp)
...
![BlogEngine.NET PostView.ascx Upload Fail](/images/tryhackme_exfilibur/web_blog_postview_upload_fail.webp)
...
![BlogEngine.NET PostView.ascx Upload Success](/images/tryhackme_exfilibur/web_blog_postview_upload_success.webp)

Setting up our listener and sending the payload with the malicious `theme` cookie, we get a shell as the `merlin` user.

![BlogEngine.NET RCE](/images/tryhackme_exfilibur/web_blog_rce_request.webp)
...
![User Flag](/images/tryhackme_exfilibur/user_flag.webp)
...
![Spawning Elevated Shell](/images/tryhackme_exfilibur/spawn_elevated_shell.webp)
...
![Lock Screen](/images/tryhackme_exfilibur/lock_screen.webp)

On the lock screen, we can click the `Ease of access` button to spawn a shell as `SYSTEM`.

![Ease of Access button](/images/tryhackme_exfilibur/ease_of_access.webp)

With this shell, we can read the root flag found in Administrator's Desktop.

![System Shell](/images/tryhackme_exfilibur/system_shell.webp)
