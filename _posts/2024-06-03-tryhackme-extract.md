...
[![Tryhackme Room Link](/images/tryhackme_extract/room_card.webp)](https://tryhackme.com/room/extract){: .center }
...
![Web 80 Index](/images/tryhackme_extract/web_80_index.webp)

Checking the page source, we see the iframe is loaded via the `/preview.php` endpoint with the `url` parameter.

![Web 80 Index Src](/images/tryhackme_extract/web_80_index_src.webp)

The request to `/preview.php` looks like this:

![Web 80 Preview Burp](/images/tryhackme_extract/web_80_preview_burp.webp)
...
![Web 80 Management](/images/tryhackme_extract/web_80_management.webp)
...
```
![Web 80 Preview Test Burp](/images/tryhackme_extract/web_80_preview_test_burp.webp)
...
![Web 80 Preview File Burp](/images/tryhackme_extract/web_80_preview_file_burp.webp)
...
![Web 80 Preview Gopher Burp](/images/tryhackme_extract/web_80_preview_gopher_burp.webp)
...
![Web 80 Preview 10000 Burp](/images/tryhackme_extract/web_80_preview_10000_burp.webp)
...
![Web 10000 Index](/images/tryhackme_extract/web_10000_index.webp)
...
![Web 10000 Customapi](/images/tryhackme_extract/web_10000_customapi.webp)
...
![Web 10000 Authentication Bypass](/images/tryhackme_extract/web_10000_authentication_bypass.webp)
...
![Web 80 Management Index](/images/tryhackme_extract/web_80_management_index.webp)
...
![Web 80 Management 2fa](/images/tryhackme_extract/web_80_management_2fa.webp)
...
![Web 80 Management Login Burp](/images/tryhackme_extract/web_80_management_login_burp.webp)
...
![Web 80 Management Flag Burp](/images/tryhackme_extract/web_80_management_flag_burp.webp)
...
![Web 80 Preview Unintended Burp](/images/tryhackme_extract/web_80_preview_file_unintended_burp.webp)
