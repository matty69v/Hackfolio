---
date: 2024-04-08 00:00:00 +0100
title: 'TryHackMe - Tryhackme Creative'
author : Matty
...
[![Tryhackme Room Link](/images/tryhackme_creative/room_card.webp)](https://tryhackme.com/r/room/creative){: .center }
...
![Web Server Port 80 Index](/images/tryhackme_creative/web_80_index.webp)
...
![Web Server Port 80 Beta Index](/images/tryhackme_creative/web_80_beta_index.webp)

Testing it with `http://creative.thm/`, it returns the contents of the URL submitted.

![Web Server Port 80 Beta Creative Test](/images/tryhackme_creative/web_80_beta_creative.webp)

And testing it with `http://creative.thm/doesnotexist`, it returns `Dead`.

![Web Server Port 80 Beta Dead Test](/images/tryhackme_creative/web_80_beta_dead.webp)
...
![Web Server Port 80 Beta Port 1337](/images/tryhackme_creative/web_80_beta_port_1337.webp)
...
![Web Server Port 80 Beta Port 1337 Home](/images/tryhackme_creative/web_80_beta_port_1337_home.webp)

Checking `/home/saad/` with `http://127.0.0.1:1337/home/saad/`, we see the presence of the `.ssh` folder.

![Web Server Port 80 Beta Port 1337 Home Saad](/images/tryhackme_creative/web_80_beta_port_1337_home_saad.webp)

Inside the `/home/saad/.ssh/` directory, there is a private ssh key as `id_rsa` which we are able to read.

![Web Server Port 80 Beta Port 1337 SSH Key](/images/tryhackme_creative/web_80_beta_port_1337_ssh_key.webp)
