...
image:
  path: /images/tryhackme_clocky/room_image.webp
---
...
![Web Server Port 8000 Robots.txt](/images/tryhackme_clocky/web_8000_robots_txt.webp)
...
![Web Server Forgot Password Request](/images/tryhackme_clocky/web_8080_forgot_password_request.webp)
...
![Web Server Forgot Password Invalid Parameter](/images/tryhackme_clocky/web_8080_password_reset_invalid_parameter.webp)
...
![Web Server Successful Password Reset](/images/tryhackme_clocky/web_8080_successful_password_reset.webp)

After logging in with the new password at the `/administrator` endpoint, we get the third flag in `/dashboard`.

![Web Server Dashboard](/images/tryhackme_clocky/web_8080_dashboard.webp)
...
![Web Server Dashboard SSRF Payload](/images/tryhackme_clocky/web_8080_ssrf_payload.webp)
...
![Web Server Dashboard SSRF Payload 127.0.0.1 Fail](/images/tryhackme_clocky/web_8080_ssrf_127-0-0-1_fail.webp)
![Web Server Dashboard SSRF Payload Localhost Fail](/images/tryhackme_clocky/web_8080_ssrf_localhost_fail.webp)
![Web Server Dashboard SSRF Payload 0.0.0.0 Fail](/images/tryhackme_clocky/web_8080_ssrf_0-0-0-0_fail.webp)
...
![Web Server Dashboard SSRF Payload Redirect Success](/images/tryhackme_clocky/web_8080_ssrf_payload_success.webp)
...
![Web Server Dashboard SSRF Payload Fourth Flag](/images/tryhackme_clocky/web_8080_ssrf_database-sql_flag.webp)

## Fifth Flag

From the `database.sql` file, we also get a password.

![Web Server Dashboard SSRF Payload Fourth Flag](/images/tryhackme_clocky/web_8080_ssrf_database-sql_password.webp)
