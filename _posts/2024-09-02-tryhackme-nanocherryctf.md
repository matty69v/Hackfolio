...
image:
  path: /images/tryhackme_nanocherryctf/room_image.webp
---
...
![Web 80 Nano Index](/images/tryhackme_nanocherryctf/web_80_nano_index.webp)
...
![Web 80 Nano Login](/images/tryhackme_nanocherryctf/web_80_nano_login.webp)

Testing the form with simple credentials, we get the message `This user doesn't exist`.

![Web 80 Nano Login Fail](/images/tryhackme_nanocherryctf/web_80_nano_login_fail.webp)
...
![Web 80 Nano Login Fail Two](/images/tryhackme_nanocherryctf/web_80_nano_login_fail2.webp)
...
![Web 80 Nano Dashboard](/images/tryhackme_nanocherryctf/web_80_nano_dashboard.webp)

Checking the posts, we also get a password for `SSH`.

![Web 80 Nano Dashboard Password](/images/tryhackme_nanocherryctf/web_80_nano_dashboard_password.webp)
...
![Web 80 Index](/images/tryhackme_nanocherryctf/web_80_index.webp)
...
![Web 80 Facts](/images/tryhackme_nanocherryctf/web_80_fact.webp)
...
![Web 80 Facts Credentials](/images/tryhackme_nanocherryctf/web_80_fact_creds.webp)
...
![Root Password Spectrogram](/images/tryhackme_nanocherryctf/rootpassword_spectrogram.webp)
...
![Root Password](/images/tryhackme_nanocherryctf/root_password.webp)
