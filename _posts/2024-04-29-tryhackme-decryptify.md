...
[![Tryhackme Room Link](/images/tryhackme_decryptify/room_card.webp)](https://tryhackme.com/room/decryptify){: .center }
...
![Web 1337 Index](/images/tryhackme_decryptify/web_1337_index.webp)
...
![Web 1337 API](/images/tryhackme_decryptify/web_1337_api.webp)
...
![Web 1337 Index Source Code](/images/tryhackme_decryptify/web_1337_index_source_code.webp)

Examining the script, we see that it is obfuscated.

![Web 1337 Api Js](/images/tryhackme_decryptify/web_1337_api_js.webp)
...
![Web 1337 Api Two](/images/tryhackme_decryptify/web_1337_api2.webp)
...
![Web 1337 Logs](/images/tryhackme_decryptify/web_1337_logs.webp)
...
![Web 1337 Login](/images/tryhackme_decryptify/web_1337_login.webp)
...
![Web 1337 Login Two](/images/tryhackme_decryptify/web_1337_login2.webp)

As we can see, it works, and we are greeted with the first flag on `http://10.10.225.140:1337/dashboard.php`. 

![Web 1337 Dashboard](/images/tryhackme_decryptify/web_1337_dashboard.webp)
...
![Web 1337 Dashboard Source Code](/images/tryhackme_decryptify/web_1337_dashboard_source_code.webp)

### Padding Oracle Attack

Testing the `date` parameter with its default value in the source code does not yield anything of interest.

![Web 1337 Dashboard Padding](/images/tryhackme_decryptify/web_1337_dashboard_padding.webp)

However, modifying the `date` parameter results in an intriguing error message indicating a **padding error**.

![Web 1337 Dashboard Padding Two](/images/tryhackme_decryptify/web_1337_dashboard_padding2.webp)
...
![Web 1337 Dashboard Flag](/images/tryhackme_decryptify/web_1337_dashboard_flag.webp)
