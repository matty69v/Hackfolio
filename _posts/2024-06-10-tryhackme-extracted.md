...
image:
  path: /images/tryhackme_extracted/room_image.webp
---
...
[![Tryhackme Room Link](/images/tryhackme_extracted/room_card.webp)](https://tryhackme.com/r/room/extractedroom){: .center }
...
![Wireshark Conversation Statistics](/images/tryhackme_extracted/wireshark_conversation_statistics.webp)
...
![Wireshark Port 1339](/images/tryhackme_extracted/wireshark_port_1339.webp)

We can use `File -> Export Objects -> HTTP` to extract the script.

![Wireshark Export Powershell Script](/images/tryhackme_extracted/wireshark_export_powershell_script.webp)
