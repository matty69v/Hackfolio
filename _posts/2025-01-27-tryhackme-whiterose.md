...
image:
  path: /images/tryhackme_whiterose/room_image.webp
---
...
[![Tryhackme Room Link](/images/tryhackme_whiterose/room_card.webp)](https://tryhackme.com/r/room/whiterose){: .center }
...
![Web 80 Index](/images/tryhackme_whiterose/web_80_index.webp)
...
![Web 80 Www Index](/images/tryhackme_whiterose/web_80_www_index.webp)

Visiting `http://admin.cyprusbank.thm/`, we are redirected to `http://admin.cyprusbank.thm/login`, where a login page is displayed.

![Web 80 Admin Index](/images/tryhackme_whiterose/web_80_admin_index.webp)
...
![Web 80 Admin Index Two](/images/tryhackme_whiterose/web_80_admin_index2.webp)
...
![Web 80 Admin Search](/images/tryhackme_whiterose/web_80_admin_search.webp)

Checking `http://admin.cyprusbank.thm/settings`, we see that we are not authorized to access this page.

![Web 80 Admin Settings](/images/tryhackme_whiterose/web_80_admin_settings.webp)

Finally, checking `Messages` redirects us to `http://admin.cyprusbank.thm/messages/?c=5`, where we can view a chat.

![Web 80 Admin Messages](/images/tryhackme_whiterose/web_80_admin_messages.webp)
...
![Web 80 Admin Messages Two](/images/tryhackme_whiterose/web_80_admin_messages2.webp)
...
![Web 80 Admin Messages Three](/images/tryhackme_whiterose/web_80_admin_messages3.webp)
...
![Web 80 Admin Index Three](/images/tryhackme_whiterose/web_80_admin_index3.webp)

We also gain access to the **Settings** page at `http://admin.cyprusbank.thm/settings`.

![Web 80 Admin Settings Two](/images/tryhackme_whiterose/web_80_admin_settings2.webp)

Testing the form, it appears to allow us to change the passwords for customers and displays the new password.

![Web 80 Admin Settings Three](/images/tryhackme_whiterose/web_80_admin_settings3.webp)
...
![Web 80 Admin Settings Four](/images/tryhackme_whiterose/web_80_admin_settings4.webp)
...
![Web 80 Admin Settings Five](/images/tryhackme_whiterose/web_80_admin_settings5.webp)
...
![Web 80 Admin Settings Six](/images/tryhackme_whiterose/web_80_admin_settings6.webp)
...
![Web 80 Admin Settings Seven](/images/tryhackme_whiterose/web_80_admin_settings7.webp)
...
![Web 80 Admin Settings Eight](/images/tryhackme_whiterose/web_80_admin_settings8.webp)
...
![Nano Sudoers File](/images/tryhackme_whiterose/nano_sudoers_file.webp)

Now, by making the addition of `web ALL=(ALL) NOPASSWD: ALL` to the file, we can grant our current user full `sudo` privileges.

![Nano Sudoers File Two](/images/tryhackme_whiterose/nano_sudoers_file2.webp)
