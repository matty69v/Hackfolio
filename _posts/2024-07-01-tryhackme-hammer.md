...
![Web 1337 Index](/images/tryhackme_hammer/web_1337_index.webp)
...
![Web 1337 Reset Password](/images/tryhackme_hammer/web_1337_reset_password.webp)

Testing the form with a random email address, we get the message: `Invalid email address!`

![Web 1337 Reset Password Invalid Email](/images/tryhackme_hammer/web_1337_reset_password_invalid.webp)
...
![Web 1337 Index Source](/images/tryhackme_hammer/web_1337_index_src.webp)
...
![Web 1337 HMR Logs](/images/tryhackme_hammer/web_1337_hmr_logs.webp)
...
![Web 1337 Reset Password Code](/images/tryhackme_hammer/web_1337_reset_password_code.webp)
...
![Web 1337 Reset Password Rate Limit Header](/images/tryhackme_hammer/web_1337_reset_password_rate_limit_header.webp)

If we continue to make requests in quick succession, we will see it decreasing.

![Web 1337 Reset Password Rate Limit Header Two](/images/tryhackme_hammer/web_1337_reset_password_rate_limit_header2.webp)

And when it reaches zero, we see that now we are getting rate-limited.

![Web 1337 Reset Password Rate Limit ](/images/tryhackme_hammer/web_1337_reset_password_rate_limit.webp)
...
![Web 1337 Reset Password Rate Limit Bypass](/images/tryhackme_hammer/web_1337_reset_password_rate_limit_bypass.webp)

But if we add the `X-Forwarded-For: 127.0.0.1` header, we can see the rate limit counter being reset.

![Web 1337 Reset Password Rate Limit Bypass Two](/images/tryhackme_hammer/web_1337_reset_password_rate_limit_bypass2.webp)

Of course, once this counter also reaches zero, we will be once again rate-limited.

![Web 1337 Reset Password Rate Limit Bypass Three](/images/tryhackme_hammer/web_1337_reset_password_rate_limit_bypass3.webp)

But simply changing the IP address in the header, we are able to reset the counter once more.

![Web 1337 Reset Password Rate Limit Bypass Four](/images/tryhackme_hammer/web_1337_reset_password_rate_limit_bypass4.webp)
...
![Web 1337 Dashboard](/images/tryhackme_hammer/web_1337_dashboard.webp)
...
![Web 1337 Dashboard Source](/images/tryhackme_hammer/web_1337_dashboard_src.webp)
...
![Web 1337 Dashboard Script Intercept](/images/tryhackme_hammer/web_1337_dashboard_script_intercept.webp)
![Web 1337 Dashboard Script Intercept Two](/images/tryhackme_hammer/web_1337_dashboard_script_intercept2.webp)
...
![Web 1337 Execute Command](/images/tryhackme_hammer/web_1337_execute_command.webp)
...
![Web 1337 Login](/images/tryhackme_hammer/web_1337_login.webp)
...
![Web 1337 Execute Command Two](/images/tryhackme_hammer/web_1337_execute_command2.webp)
...
![Web 1337 Execute Command Request](/images/tryhackme_hammer/web_1337_execute_command_request.webp)
...
![Web 1337 Execute Command LS](/images/tryhackme_hammer/web_1337_execute_command_ls.webp)
...
![Web 1337 Execute Command Invalid Token](/images/tryhackme_hammer/web_1337_execute_command_invalid_token.webp)
...
![JWT Decoded](/images/tryhackme_hammer/jwt_decoded.webp)
...
![JWT Forged](/images/tryhackme_hammer/jwt_forged.webp)

Testing the token we forged, we see it works as we don't get the `Invalid token` error.

![Web 1337 Execute Command Forged JWT](/images/tryhackme_hammer/web_1337_execute_command_forged_jwt.webp)

Now that we are able to forge tokens, we can change our role in the token data from `user` to `admin`.

![JWT Forged Two](/images/tryhackme_hammer/jwt_forged2.webp)
...
![Web 1337 Execute Command Forged JWT Two](/images/tryhackme_hammer/web_1337_execute_command_forged_jwt2.webp)

With this, we are able to read the second flag at `/home/ubuntu/flag.txt` and complete the room.

![Web 1337 Execute Command Second Flag](/images/tryhackme_hammer/web_1337_execute_command_second_flag.webp)
