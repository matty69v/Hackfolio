...
image:
  path: /images/tryhackme_ua-high-school/room_image.webp
---
...
![Web 80 Index](/images/tryhackme_ua_high_school/web_80_index.webp)
...
![Web 80 Contact](/images/tryhackme_ua_high_school/web_80_contact.webp)

## Shell as www-data

Looking at the source code for the page, we can see it includes a `CSS` file from the `/assets` directory.

![Web 80 Index Source](/images/tryhackme_ua_high_school/web_80_index_source.webp)

Checking the `styles.css` file, we can see it sets the background image to `/assets/images/yuei.jpg`.

![Web 80 Assets CSS Source](/images/tryhackme_ua_high_school/web_80_assets_css_source.webp)
...
![Web 80 Assets](/images/tryhackme_ua_high_school/web_80_assets.webp)

And visiting the `http://10.10.74.25/assets/images/`, we get an `Forbidden` page.

![Web 80 Assets Images](/images/tryhackme_ua_high_school/web_80_assets_images.webp)
...
![Web 80 Assets Request](/images/tryhackme_ua_high_school/web_80_assets_request.webp)
...
![Web 80 Assets PHP Request](/images/tryhackme_ua_high_school/web_80_assets_php_request.webp)

And if we make a request to `/assets/index.html`, we get a `404` response.

![Web 80 Assets HTML Request](/images/tryhackme_ua_high_school/web_80_assets_html_request.webp)
...
![Hexeditor JPG Magic Bytes](/images/tryhackme_ua_high_school/hexeditor_jpg_magic_bytes.webp)

After making the changes and saving it, we are able to display the image.

![Oneforall](/images/tryhackme_ua_high_school/oneforall.webp)
